...
function webMain() 
{
  ...
  var animate = function()
  {
    ...
    if(flagStart)
    {
      ...
      rigid[1].vAcc.y =  - spring[0].constant * disp / rigid[1].mass - 2.0 * gamma * rigid[1].vVel.y + forceE * Math.sin(omega * time);
...
function initObject()
{
  ...
  forceE = parseFloat(form2.forceE.value);//強制信号角振幅

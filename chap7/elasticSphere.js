...
function webMain() 
{
  ...
  sm3 = new SpringMass3();//3次元バネ質点モデルのオブジェクト
...
//		collision(tt);//collisionSM2_R.jsに実装
...
//  sm3.height0 = 0.8;
  ...
  sm3.rigid2.vSize = new Vector3(0.7, 0.7, 0.7);
...
function onClickDebug()
{
  ...
  sm3.rigid2.flagDebug = flagDebug;
  display();
}

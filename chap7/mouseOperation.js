...
var camera; //カメラ
var light;  //光源
var sm1;// = new SpringMass1();//1次元バネ質点モデルのオブジェクト
var floor0;
...
function webMain() 
{
  ...
  var maxZ = -10, nn;
  var period = 0, t1 = 0, t2 = 0, freq;  var animate = function()
  {
    //繰り返し呼び出す関数を登録
...
function initObject()
{
  ...
  sm1.totalLength = 2;//全体の長さ(固定）
  sm1.totalLength0 = parseFloat(form1.Length0.value);;//全体の自然長
  sm1.initialize();
  sm1.flagCollision = true;//衝突処理を有効化

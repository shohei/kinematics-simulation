...
function initObject()
{
  ...
  var totalLen0 = 2;//parseFloat(form2.totalLen0.value);//全体の自然長
  sm2.lengthX0 = totalLen0 / sm2.numRow;
  sm2.lengthY0 = totalLen0 / sm2.numCol;
  sm2.vEuler = new Vector3(0, 0, 0);
  sm2.height0 = 2.0;
  sm2.radius = 0.05;
  sm2.vPos = new Vector3(-sm2.totalLenX/2, -sm2.totalLenY/2, sm2.height0);//SMMの原点の位置
  sm2.initialize();
  ...
  sm2.rigid2.kind = "SPHERE";//球のみ
  sm2.rigid2.nSlice = 10;
  sm2.rigid2.nStack = 10;
  sm2.rigid2.mass = 1000;
  sm2.rigid2.flagTexture = true;
  sm2.rigid2.vSize = new Vector3(0.8, 0.8, 0.8);
  sm2.rigid2.vPos = new Vector3(0.0, 0.0, sm2.rigid2.vSize.z / 2);
  sm2.rigid2.ready();//calcMomentOfInertia();
  sm2.rigid2.state = "RESTING";
